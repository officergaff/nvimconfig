return {
    {
        "neoclide/coc.nvim",
        branch = "release",
        build = "npm i", -- Ensures dependencies are installed
        config = function()
            vim.g.coc_global_extensions = {
                ...
                'coc-emmet',          -- Emmet support for HTML/CSS
                'coc-tailwindcss'     -- Tailwind CSS support (if you use it)
            }
            ...
            -- Set global defaults for snippet navigation
            vim.g.coc_snippet_next = '<c-j>'
            vim.g.coc_snippet_prev = '<c-k>'

            -- Explicit mappings for expand and select
